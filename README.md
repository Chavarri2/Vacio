...
Como eclipse es un programa que deja mucho que desear, para que el proyecto funcione correctamente debes buscar la clase Utilidades y escribir manualmente en el metodo "leerArchivo" la ruta absoluta de tu archivo en el ordenador. Esto se debe a que de lo contrario habria que configurar muchisimas cosas, emtre ella maven manualmente. Visual Studio hace esto de forma automatica, al cambiar el proyecto el propio programa Eclipse desconfiguro toda la estructura de paquetes.
